...
evaluate!(u, F::SPSystem, x, p, ::NullCache) = SP.evaluate!(u, F.system, x, p)
...
jacobian!(U, F::SPSystem, x, p, ::NullCache) = SP.jacobian!(U, F.system, x, p)
...
evaluate_and_jacobian!(u, U, F::SPSystem, x, p, ::NullCache) = SP.evaluate_and_jacobian!(u, U, F.system, x, p)
...
differentiate_parameters!(U, F::SPSystem, x, p, ::NullCache) = SP.differentiate_parameters!(U, F.system, x, p)
